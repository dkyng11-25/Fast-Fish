...
|---------------|-------|---------------|-----------|
| Core Subcategories (直筒裤, 束脚裤, 锥形裤) | 231 | 69 | ✅ 100% |
| Summer Items (T恤, 短裤, 短袖) | 231 | 69 | ✅ |
| All-Season Items (内衣, 配饰) | 154 | 27 | ✅ |
| Winter Items (羽绒服, 棉服, 毛呢大衣) | 231 | 0 | Skipped (Ineligible) |
| Transition Items (夹克, 针织衫) | 153 | 0 | Skipped (Ineligible) |
...
```
Store: S01012
SPU: SPU_直筒_0015 (Straight-Leg Pants)
