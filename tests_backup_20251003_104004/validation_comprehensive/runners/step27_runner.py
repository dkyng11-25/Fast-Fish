#!/usr/bin/env python3
"""
Step 27 Validation Runner

Handles validation of gap matrix generation from Step 27 of the pipeline.
...
def validate_step27_gap_matrix_generator(period: str = "202508A", 
                                           data_dir: str = "../output") -> Dict[str, Any]:
    """
    Validate Step 27 gap matrix generation output.
    ...
    """
    logger.info(f"Starting Step 27 validation for period {period}")
    ...
    try:
        ...
        expected_files = {
            'main_output': f"gap_matrix_generator_{period}.csv",
            'summary_output': f"gap_matrix_generator_summary_{period}.csv",
            'log_file': f"gap_matrix_generator_log_{period}.log"
        }
        ...
        logger.info(f"Step 27 validation completed. Passed: {results['validation_passed']}")
        
    except Exception as e:
        logger.error(f"Error during Step 27 validation: {str(e)}")
...
def run_step27_validation(period: str = "202508A") -> Dict[str, Any]:
    """
    Run Step 27 validation.
    ...
    Returns:
        Dictionary with validation results
    """
    return validate_step27_gap_matrix_generator(period)
...
if __name__ == "__main__":
    ...
    results = run_step27_validation(period)
    
    print(f"Step 27 validation results:")
