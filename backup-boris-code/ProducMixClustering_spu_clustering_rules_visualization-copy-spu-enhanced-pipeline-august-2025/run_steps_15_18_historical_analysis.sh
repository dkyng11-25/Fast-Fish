...
cd src && python step15_download_historical_baseline.py && cd ..
if [ $? -ne 0 ]; then
...
cd src && python step16_create_comparison_tables.py && cd ..
if [ $? -ne 0 ]; then
...
cd src && python step17_augment_recommendations.py && cd ..
if [ $? -ne 0 ]; then
...
cd src && python step18_validate_results.py && cd ..
if [ $? -ne 0 ]; then
