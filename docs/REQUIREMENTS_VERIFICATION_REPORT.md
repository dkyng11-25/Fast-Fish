...
| R004 | Download Weather Data | `step4_download_weather_data.py` | Downloads weather data for store locations |
| R005 | Calculate Feels-Like Temperature | `step5_calculate_feels_like_temperature.py` | Creates temperature bands for clustering |
