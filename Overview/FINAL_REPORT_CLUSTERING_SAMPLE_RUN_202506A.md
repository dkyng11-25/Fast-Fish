...
## 4. Step 2: Extract Store Coordinates

### Purpose
Extract geographic coordinates from store data for weather-based analysis.
...
### Purpose
Create a store × SPU matrix as input for clustering algorithm.
...
### Weather Data DataFrame (First 15 Rows)
