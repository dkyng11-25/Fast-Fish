...
def _seed_synthetic_inputs_with_duplicates(sandbox: Path) -> None:
    ...
    fast_fish_data = {
        ...
        'period_label': ['202508A', '202508A', '202508A']
    }
...
def _load_step32_outputs(sandbox: Path) -> Dict[str, Any]:
    ...
    # Find summary file
    summary_files = list((sandbox / "output").glob("store_allocation_summary_202508A_*.md"))
    if summary_files:
...
class TestStep32DuplicateColumns:
    ...
    def test_edge_case_empty_allocations(self, tmp_path):
        ...
        for filename, data in [
            ("client_desired_store_group_style_tags_targets_202508A_20250927_125630.csv", 
             {'str_code': [1001], 'cluster_id': [1]}),
            ("enriched_store_attributes_202508A_20250920_175036.csv", 
